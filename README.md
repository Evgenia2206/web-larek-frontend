...
* product:change - изменение списка карточек товаров, отображаемых на главной странице;  
...
* card:basket - добавление карточки товара в корзину;  
* card:cancel - удаление карточки товара из корзины;  
* modal:open - открытие модального окна;  
* modal:close - закрытие модального окна;  
* basket:change - изменение отображения на главной странице количества товаров, добавленных в корзину;  
* basket:open - открытие окна корзины;  
* order:open - открытие окна заказа;  
* order:input - ввод данных в форме заказа; 
* /^order\..*:input/ - проверка валидности полей и передача данных в соответствующие модели;    
